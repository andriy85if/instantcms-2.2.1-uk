...
(17, 1, 1, NULL, 'Про проект', 1, '/pages/about.html', NULL, NULL, NULL, '2013-08-08 15:07:27', 0, NULL),
(18, 1, 1, NULL, 'Правила сайту', 2, '/pages/rules.html', NULL, NULL, NULL, '2013-08-08 15:09:13', 0, NULL),
...
(33, 17, 1, NULL, 'Игрушки становятся дороже', 2, '/news/2-igrushki-stanovjatsja-dorozhe.html', NULL, NULL, NULL, '2013-09-09 16:02:07', 0, NULL),
(34, 17, 1, NULL, 'В городе открыт сервис для ретро-автомобилей', 3, '/news/3-v-gorode-otkryt-servis-dlja-retro-avtomobilei.html', NULL, NULL, NULL, '2013-09-09 16:03:25', 0, NULL),
(35, 17, 1, NULL, 'Дачный сезон на Урале официально начался', 4, '/news/4-dachnyi-sezon-otkryt.html', NULL, NULL, NULL, '2013-09-09 16:04:25', 0, NULL),
(36, 17, 1, NULL, 'Бизнес ожидает снижения налогов', 5, '/news/5-snizhenie-nalogov-dlja-biznesa.html', NULL, NULL, NULL, '2013-09-09 16:05:26', 0, NULL),
(37, 17, 1, NULL, 'Все больше россиян покупают дома за границей', 6, '/news/6-vse-bolshe-rossijan-pokupayut-nedvizhimost-za-granicei.html', NULL, NULL, NULL, '2013-09-12 12:09:25', 0, NULL),
(38, 17, 1, NULL, 'Количество преступлений в России сокращается', 7, '/news/7-kolichestvo-prestuplenii-v-rossii-sokraschaetsja.html', NULL, NULL, NULL, '2013-09-12 12:10:55', 0, NULL),
(40, 17, 1, NULL, 'Россияне стали первыми на Чемпионате Мира', 9, '/news/9-rossijane-stali-pervymi-na-chempionate-mira.html', NULL, NULL, NULL, '2013-09-12 12:14:13', 0, NULL),
(56, 13, 1, NULL, 'Мифологический реципиент', 10, '/articles/10-mifologicheskii-recipient.html', NULL, NULL, NULL, '2013-10-09 14:48:19', 0, NULL),
(57, 13, 1, NULL, 'Общественный анализ зарубежного опыта', 11, '/articles/11-obschestvennyi-analiz-zarubezhnogo-opyta.html', NULL, NULL, NULL, '2013-10-09 14:54:36', 0, NULL),
(67, 14, 1, 1, 'Мой первый пост в сообществе', 5, '/posts/5-moi-pervyi-post-v-soobschestve.html', NULL, NULL, NULL, '2013-11-13 16:43:07', 0, NULL),
(69, 16, 1, NULL, 'Продам квартиру в новостройке', 7, '/board/7-prodam-kvartiru-v-novostroike.html', NULL, NULL, NULL, '2013-11-13 16:58:30', 0, NULL);
...
CREATE TABLE `{#}comments` (
  ...
  `parent_id` int(11) DEFAULT NULL COMMENT 'ID батьківського коментаря',
  `level` tinyint(4) DEFAULT NULL COMMENT 'Рівень вкладеності',
  `ordering` int(11) DEFAULT NULL COMMENT 'Порядковий номер в дереві',
  ...
  `target_id` int(11) DEFAULT NULL COMMENT 'ID об’єкту коментування',
  ...
  `is_deleted` tinyint(1) DEFAULT NULL COMMENT 'Коментар видалений?',
  `is_private` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Тільки для друзів?',
...
(5, 4, 2, 2, 1, '2013-11-13 16:52:55', 'content', 'articles', 11, 'articles/11-obschestvennyi-analiz-zarubezhnogo-opyta.html', 'Общественный анализ зарубежного опыта', NULL, NULL, NULL, 'Відповідь на коментар вище', 'Відповідь на коментар вище', NULL, 0, 0);
...
CREATE TABLE `{#}content_datasets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ctype_id` int(11) DEFAULT NULL COMMENT 'ID типу контенту',
  ...
  `is_visible` tinyint(1) DEFAULT NULL COMMENT 'Відображати набір на сайті?',
...
CREATE TABLE `{#}content_types` (
  ...
  `is_premod_add` tinyint(1) DEFAULT NULL COMMENT 'Модерація при створенні?',
  `is_premod_edit` tinyint(1) DEFAULT NULL COMMENT 'Модерація при редагуванні',
  `is_cats` tinyint(1) DEFAULT NULL COMMENT 'Категорії увімкнені?',
  `is_cats_recursive` tinyint(1) DEFAULT NULL COMMENT 'Наскрізний перегляд категорій?',
  `is_folders` tinyint(1) DEFAULT NULL,
  `is_in_groups` tinyint(1) DEFAULT NULL COMMENT 'Створення в групах',
  `is_in_groups_only` tinyint(1) DEFAULT NULL COMMENT 'Створення тільки в групах',
  `is_comments` tinyint(1) DEFAULT NULL COMMENT 'Коментарі увімкнені?',
  `is_comments_tree` tinyint(1) DEFAULT NULL,
  `is_rating` tinyint(1) DEFAULT NULL COMMENT 'Дозволити рейтинг?',
  `is_rating_pos` tinyint(1) DEFAULT NULL,
  `is_tags` tinyint(1) DEFAULT NULL,
  `is_auto_keys` tinyint(1) DEFAULT NULL COMMENT 'Автоматична генерація ключових слів?',
  `is_auto_desc` tinyint(1) DEFAULT NULL COMMENT 'Автоматична генерація опису?',
  `is_auto_url` tinyint(1) DEFAULT NULL COMMENT 'Генерувати URL із заголовку?',
  `is_fixed_url` tinyint(1) DEFAULT NULL COMMENT 'Не змінювати URL при зміні запису?',
...
CREATE TABLE `{#}controllers` (
  ...
  `name` varchar(32) NOT NULL COMMENT 'Системне ім’я',
  `is_enabled` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Увімкнений?',
  ...
  `is_backend` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Є адмінка?',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
...
(16, 'Красота окружающей природы', 'Фотографии из коллекции сайта deviantart.com', '16-krasota-okruzhayuschei-prirody', 'фотографии, коллекции, сайта, deviantart.com', 'Фотографии из коллекции сайта deviantart.com', NULL, 'приклад, фото', '2013-11-13 16:48:18', '2013-11-13 16:48:18', NULL, 1, 0, 1, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 0, 1, NULL, NULL, 0, '---\nbig: u1/004/4f11cd73.jpg\nnormal: u1/004/5b0ff517.jpg\nsmall: u1/004/5edb4681.jpg\n', 4, NULL),
...
CREATE TABLE `{#}groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `owner_id` int(11) DEFAULT NULL COMMENT 'Автор',
  ...
  `members_count` int(11) NOT NULL DEFAULT '0' COMMENT 'К-сть членів',
  `join_policy` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Політика приєднання',
  `edit_policy` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Політика редагування',
  `wall_policy` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Політика стіни',
  `is_closed` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Закрита?',
  PRIMARY KEY (`id`),
...
CREATE TABLE `{#}groups_invites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) DEFAULT NULL COMMENT 'ID групи',
  `user_id` int(11) DEFAULT NULL COMMENT 'ID того, хто запросив',
  `invited_id` int(11) DEFAULT NULL COMMENT 'ID того, кого запросили',
  PRIMARY KEY (`id`),
  KEY `group_id` (`group_id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `{#}groups_members` (
  ...
  `group_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `role` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'Роль користувача в групі',
...
CREATE TABLE `{#}menu` (
  ...
  `is_fixed` tinyint(1) DEFAULT NULL COMMENT 'Заборонено видаляти?',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
...
CREATE TABLE `{#}menu_items` (
  ...
  `parent_id` int(11) DEFAULT '0' COMMENT 'ID батьківського пункту',
...
CREATE TABLE `{#}rating_log` (
  ...
  `target_id` int(11) DEFAULT NULL COMMENT 'ID суб’єкту (записи контенту, який оцінюється)',
  `score` tinyint(4) DEFAULT NULL COMMENT 'Значення оцінки',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `target_controller` (`target_controller`),
  KEY `target_type` (`target_subject`),
...
(1, 'Перевід користувачів між групами', 'users', 'migration', 1440, '2013-08-16 15:28:05', 1, 0),
(2, 'Створення карти сайту', 'sitemap', 'generate', 1440, '2013-10-09 15:25:38', 1, 0),
(3, 'Видача запрошень користувачам', 'auth', 'send_invites', 1440, '2013-09-06 12:28:31', 1, 0),
...
CREATE TABLE `{#}users` (
  ...
  `is_admin` tinyint(1) DEFAULT NULL COMMENT 'Адміністратор?',
  ...
  `is_online` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Користувач онлайн?',
  `is_locked` tinyint(1) DEFAULT NULL COMMENT 'Заблокований',
  ...
  `files_count` int(11) NOT NULL DEFAULT '0' COMMENT 'К-сть завантажених файлів',
  `friends_count` int(11) NOT NULL DEFAULT '0' COMMENT 'К-сть друзів',
  ...
  `status_id` int(11) DEFAULT NULL COMMENT 'Текстовий статус',
...
CREATE TABLE `{#}users_contacts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT 'ID користувача',
  `contact_id` int(11) DEFAULT NULL COMMENT 'ID контакту (іншого користувача)',
  `date_last_msg` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Дата останнього повідомлення',
  `messages` int(11) NOT NULL DEFAULT '0' COMMENT 'К-сть повідомлень',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `{#}users_friends` (
  ...
  `is_mutual` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Дружба взаємна?',
  PRIMARY KEY (`id`),
  KEY `from_id` (`user_id`),
  KEY `to_id` (`friend_id`),
...
CREATE TABLE `{#}users_groups` (
  ...
  `is_fixed` tinyint(1) DEFAULT NULL COMMENT 'Системна?',
  `is_public` tinyint(1) DEFAULT NULL COMMENT 'Групу можна вибрати при реєстрації?',
  `is_filter` tinyint(1) DEFAULT NULL COMMENT 'Виводити групу в фільтрі користувачів?',
  PRIMARY KEY (`id`),
  KEY `is_fixed` (`is_fixed`),
...
CREATE TABLE `{#}users_ignors` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT 'ID користувача',
  `ignored_user_id` int(11) NOT NULL COMMENT 'ID користувача, котрий ігнорується',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `{#}users_karma` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT 'Хто поставив',
  `profile_id` int(11) DEFAULT NULL COMMENT 'Кому поставив',
...
CREATE TABLE `{#}users_messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `from_id` int(11) NOT NULL COMMENT 'ID відправника',
  `to_id` int(11) NOT NULL COMMENT 'ID отримувача',
...
CREATE TABLE `{#}users_statuses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT 'Користувача',
  ...
  `replies_count` int(11) NOT NULL DEFAULT '0' COMMENT 'Кількість відповідей',
  `wall_entry_id` int(11) DEFAULT NULL COMMENT 'ID запису на стіні',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `date_pub` (`date_pub`),
...
CREATE TABLE `{#}wall_entries` (
  ...
  `profile_id` int(11) DEFAULT NULL COMMENT 'ID профілю',
  `user_id` int(11) DEFAULT NULL COMMENT 'ID автора',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT 'ID батьківського запису',
  `status_id` int(11) DEFAULT NULL COMMENT 'Зв’язок зі статусом користувача',
...
(2, '2013-07-24 11:35:31', NULL, 'user', 1, 1, 1, NULL, 'Дякую, що заглянули в мій профіль!', 'Дякую, що заглянули в мій профіль!');
...
CREATE TABLE `{#}widgets_bind` (
  ...
  `is_title` tinyint(1) DEFAULT '1' COMMENT 'Показувати заголовок',
  `is_enabled` tinyint(1) DEFAULT NULL COMMENT 'Увімкнений?',
  `is_tab_prev` tinyint(1) DEFAULT NULL COMMENT 'Об’єднувати з попереднім?',
  `groups_view` text COMMENT 'Показувати групам',
  `groups_hide` text COMMENT 'Не показувати групам',
  `options` text DEFAULT NULL COMMENT 'Опції',
  `page_id` int(11) DEFAULT NULL COMMENT 'ID сторінки для виведення',
